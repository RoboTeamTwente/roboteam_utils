...
PID::PID(std::tuple<double, double, double> pid) : PID(std::get<0>(pid), std::get<1>(pid), std::get<2>(pid)) {}

PID::PID(std::tuple<double, double, double, double> pidf) : PID(std::get<0>(pidf),
                                                                std::get<1>(pidf),
                                                                std::get<2>(pidf),
                                                                std::get<3>(pidf)) {}
 ...
 * @return
 */
bool PID::bounded(double value, double min, double max) { return (min < value) && (value < max); }
