...
double Rectangle::minX() const {
    return fmin(corner1.x, corner2.x);
}
double Rectangle::maxX() const {
    return fmax(corner1.x, corner2.x);
}
double Rectangle::minY() const {
    return fmin(corner1.y, corner2.y);
}
double Rectangle::maxY() const {
    return fmax(corner1.y, corner2.y);
}
...
std::vector<LineSegment> Rectangle::lines() const {
    ...
    std::vector<LineSegment> lines = {LineSegment(points[0], points[1]),
                                      LineSegment(points[1], points[2]),
                                      LineSegment(points[2], points[3]),
                                      LineSegment(points[3], points[0])};
    return lines;
}
Polygon Rectangle::asPolygon() const {
