...
class Vector2 {
   public:
     ...
     */
    constexpr Vector2() : x(0.0), y(0.0), epsilon(0.00001) {}

    constexpr Vector2(const Vector2 &copy) : x(copy.x), y(copy.y), epsilon(0.00001) {}

    constexpr Vector2(const double x, const double y) : x(x), y(y), epsilon(0.00001) {}
