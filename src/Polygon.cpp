...
Polygon::Polygon(const std::vector<rtt::Vector2> &_vertices) : vertices{_vertices} {}

size_t Polygon::amountOfVertices() const { return vertices.size(); }
...
Vector2 Polygon::verticeCentroid() const { return std::accumulate(vertices.begin(), vertices.end(), Vector2(0, 0)) /= vertices.size(); }

bool Polygon::isValid() const { return false; }
