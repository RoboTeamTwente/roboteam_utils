...
double Angle::getAngle() const noexcept { return angle; }

void Angle::setAngle(double angle) noexcept { *this = Angle(angle); }
...
double Angle::angleDiff(Angle const &other) const noexcept { return (*this - other).angle; }
...
bool Angle::operator==(const Angle &other) const noexcept { return fabs(this->angle - other.angle) < epsilon; }

bool Angle::operator==(const double &scalar) const noexcept { return *this == Angle(scalar); }

bool Angle::operator!=(const Angle &other) const noexcept { return !(*this == other); }

bool Angle::operator!=(const double &scalar) const noexcept { return *this != Angle(scalar); }

bool Angle::operator<(const Angle &other) const noexcept { return abs(this->angle) < abs(other.angle); }

Angle Angle::operator+(const Angle &other) const noexcept { return Angle(this->angle + other.angle); }

Angle Angle::operator+(const double &scalar) const noexcept { return Angle(this->angle + scalar); }
...
Angle::operator double() const noexcept { return this->angle; }
